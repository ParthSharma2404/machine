...
const fetchQuote = async (
  ...
  const url = `https://li.quest/v1/quote?fromChain=${fromChainId}&toChain=${toChainId}&fromToken=${fromTokenAddress.toLowerCase()}&toToken=${toTokenAddress.toLowerCase()}&fromAmount=${parsedAmount}&fromAddress=${userAddress}&fee=0.005&feeReceiver=0x809dE57cddA3F5CAFce3F89DA9ad9269E1fFfA52`;
